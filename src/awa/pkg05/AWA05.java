...
import awa.pkg05.EvaluationRepas;
...
public class AWA05 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Valider.setOnAction(new EventHandler<ActionEvent>() {
            ...
            @Override
            public void handle(ActionEvent event) {
                EvaluationRepas leRepas= new EvaluationRepas(Integer.parseInt(radio.getSelectedToggle().getUserData().toString().trim()),textAreaCom.getText());
